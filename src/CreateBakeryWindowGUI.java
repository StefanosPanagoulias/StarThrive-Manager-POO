...
/**
 * Classe utilizada para representar a janela de criar uma pastelaria
 */
public class CreateBakeryWindowGUI extends JFrame{
     ...
     */
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()==botão2){
                RestaurantBusinessWindowGUI escolhaRestauracao = new RestaurantBusinessWindowGUI(manager,f);
                frame.dispose();
            }
     ...
     */
    public CreateBakeryWindowGUI(StarThriveManager manager, File f){
        this.manager = manager;
        this.f = f;



        labelNome = new JLabel("Bakery name");
        ...
        caixaTextoNumeroMedioBolosDia= new JTextField();
        ...
        caixaTextoFaturacaoAnualMediaBolo= new JTextField();
        ...
        frame = new JFrame();
        frame.setTitle("Create a bakery");

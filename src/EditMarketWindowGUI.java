...
/**
 * Classe utilizada para representar a janela de edição de um mercado
 */
public class EditMarketWindowGUI extends JFrame {
    /**
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()==botão1){
                ...
                if(ok){
                    ...
                    manager.eliminarListaMercado(company);
     ...
     */
    public EditMarketWindowGUI(StarThriveManager manager, Market e, File f){
        ...
        labelNome = new JLabel("Market name");
        ...
        caixaTextoAreaCorredores = new JTextField(String.valueOf(e.getAreaCorredores()));
        ...
        caixaTextoFaturacaoAnualM2 = new JTextField(String.valueOf(e.getFaturacaoAnualm2()));

...
/**
 * Classe utilizada para representar a janela de editar uma pastelaria
 */
public class EditBakeryWindowGUI extends JFrame {
    /**
    ...
    /**
     * Painel a que vão ser associados a label do salário anual médio dos empregados e a  sua caixa de texto correspondente
     */
    ...
    /**
     * Painel a que vão ser associados a label com o número médio de bolos vendidos por dia e a caixa de texto correspondente
     */
    private  JPanel panel8;

    /**
     * Painel a que vão ser associados a label com o valor médio faturado anualmente por cada bolo vendido e a caixa de texto correspondente
     */
    ...
    /**
     * Caixa de texto do salário médio dos empregados
     */
    ...
    /**
     * Caixa de texto do número médio de bolos vendidos por dia
     */
    private JTextField caixaTextoNumeroMedioBolosDia;

    /**
     * Caixa de texto do valor médio faturado anualmente por cada bolo vendido
     */
    private JTextField caixaTextoFaturacaoAnualMediaBolo;
    ...
    /**
     * label do salário médio dos empregados
     */
    ...
    /**
     * label do número médio de bolos vendidos por dia
     */
    private JLabel labelNumeroMedioBolosDia;

    /**
     * label do valor médio faturado anualmente por cada bolo vendido
     */
    private JLabel labelFaturacaoAnualMediaBolo;
    ...
    private class TextfieldListener implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if(e.getSource()== caixaTextoNumeroMedioBolosDia){
                if(caixaTextoNumeroMedioBolosDia.getBackground() == Color.red){
                    caixaTextoNumeroMedioBolosDia.setBackground(Color.white);

                }

            }
            if(e.getSource() == caixaTextoFaturacaoAnualMediaBolo){
                if(caixaTextoFaturacaoAnualMediaBolo.getBackground() == Color.red){
                    caixaTextoFaturacaoAnualMediaBolo.setBackground(Color.white);
    ...
    private class ButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource()==botão1){
                ...
                try{
                    double numeroMedioBolosDia = Double.parseDouble(caixaTextoNumeroMedioBolosDia.getText());
                    if(numeroMedioBolosDia <0 )throw new IllegalArgumentException("");

                }
                catch(NumberFormatException ex){
                    caixaTextoNumeroMedioBolosDia.setBackground(Color.red);
                    caixaTextoNumeroMedioBolosDia.setText("");


                    JOptionPane.showMessageDialog(null, "The average number of cakes sold per day must be a number!", "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, "The average number of cakes sold per day cannot be negative!", "Error", JOptionPane.ERROR_MESSAGE);

                    ok = false;
                }

                try{
                    double faturacaoAnualBolo = Double.parseDouble(caixaTextoFaturacaoAnualMediaBolo.getText());
                    if(faturacaoAnualBolo<0) throw new IllegalArgumentException("");
                    ...
                    caixaTextoFaturacaoAnualMediaBolo.setBackground(Color.red);
                    caixaTextoFaturacaoAnualMediaBolo.setText("");

                    JOptionPane.showMessageDialog(null, "Average annual revenue per cake must be a number!", "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, "Average annual revenue per cake must be a positive number!", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if(ok){
                    ...
                    Company aux = new Bakery(caixaTextoNome.getText(),caixaTextoDistrito.getText(),local,Double.parseDouble(caixaTextoSalario.getText()),Integer.parseInt(caixaTextoNumeroEmpregados.getText()),Double.parseDouble(caixaTextoNumeroClientes.getText()),Double.parseDouble(caixaTextoNumeroMedioBolosDia.getText()),Double.parseDouble(caixaTextoFaturacaoAnualMediaBolo.getText()));
                    //System.out.println(aux.toString());
                    manager.eliminarEmpresa(company);
                    manager.addEmpresa(aux);

                    manager.eliminarListaPastelaria(company);
                    manager.addListaPastelaria(aux);
     ...
     */
    public EditBakeryWindowGUI(StarThriveManager manager, Bakery e, File f){
        ...
        labelNome = new JLabel("Name of the bakery");
        ...
        labelNumeroMedioBolosDia= new JLabel("Average number of cakes sold per day");
        labelFaturacaoAnualMediaBolo= new JLabel("Average annual revenue");
        ...
        caixaTextoNumeroMedioBolosDia= new JTextField(String.valueOf(e.getNumeroMedioBolosDia()));
        caixaTextoNumeroMedioBolosDia.setPreferredSize(new Dimension(250,40));

        caixaTextoNumeroMedioBolosDia.addMouseListener(textfieldListener);

        caixaTextoFaturacaoAnualMediaBolo= new JTextField(String.valueOf(e.getFaturacaoAnualMediaBolo()));
        caixaTextoFaturacaoAnualMediaBolo.setPreferredSize(new Dimension(250,40));

        caixaTextoFaturacaoAnualMediaBolo.addMouseListener(textfieldListener);
        ...
        frame.setTitle("Editar uma pastelaria");
        ...
        panel8.add(labelNumeroMedioBolosDia);
        panel8.add(caixaTextoNumeroMedioBolosDia);

        panel9.add(labelFaturacaoAnualMediaBolo);
        panel9.add(caixaTextoFaturacaoAnualMediaBolo);

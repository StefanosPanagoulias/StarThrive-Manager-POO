...
/**
 * Classe utilizada para representar a janela de criar um café
 */
public class CreateCafeWindowGUI extends JFrame{
   ...
   private JFrame frame;
    ...
    private class ButtonListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(e.getSource() == botão2){
                RestaurantBusinessWindowGUI res = new RestaurantBusinessWindowGUI(manager,f);
                frame.dispose();
            }
     ...
     */
    public CreateCafeWindowGUI(StarThriveManager manager, File f){
        ...
        labelNumeroMedioCafesDia = new JLabel("Average number of coffees sold per day");
        labelFaturacaoAnual = new JLabel("Average annual revenue");
        ...
        caixaTextoNumeroMedioCafesDia = new JTextField();
        ...
        caixaTextoFaturacaoAnual = new JTextField();

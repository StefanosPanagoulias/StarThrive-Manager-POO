...
/**
 * Classe utilizada para representar a janela de editar uma frutaria
 */
public class EditFruitShopWindowGUI extends JFrame {
    /**
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource()==botão1){
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "The number of products must be a number!", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "Annual revenue per product must be an integer!", "Error", JOptionPane.ERROR_MESSAGE);
                ...
                if(ok){
                    ...
                    manager.eliminarListaFrutaria(company);
     ...
     */
    public EditFruitShopWindowGUI(StarThriveManager manager, FruitShop e, File f){
        ...
        labelNome = new JLabel("Name of the fruit shop");
        ...
        caixaTextoNumeroProdutos = new JTextField(String.valueOf(e.getNumeroProdutos()));
        ...
        caixaTextoFaturacaoAnualProduto = new JTextField(String.valueOf(e.getFaturacaoAnualProduto()));
        ...
        caixaTextoCustoAnualLimpeza = new JTextField(String.valueOf(e.getCustoAnualLimpeza()));
        ...
        frame.setTitle("Edit a fruit shop");

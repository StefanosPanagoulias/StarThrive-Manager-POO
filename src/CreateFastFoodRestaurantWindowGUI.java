...
/**
 * Classe utilizada para representar a janela de criar um restaurante de fast food
 */
public class CreateFastFoodRestaurantWindowGUI extends JFrame{
    ...
    /**
     * label do valor médio faturado por cada cliente do drive-thru
     */
    ...
    private class ButtonListener implements ActionListener{
        ...
        public void actionPerformed(ActionEvent e) throws IllegalArgumentException {
            ...
            if(e.getSource()==botão1){
                //System.out.println("Informação submetida: "+caixaTextoNome.getText());
                ...
                try{
                    ...
                    JOptionPane.showMessageDialog(null, "Average revenue per drive-thru client must be a number!", "Error", JOptionPane.ERROR_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, "Average revenue per drive-thru client must be a positive number!", "Error", JOptionPane.ERROR_MESSAGE);
     ...
     */
    public CreateFastFoodRestaurantWindowGUI(StarThriveManager manager, File f) {
        ...
        labelNumeroClientesDriveThru = new JLabel("Average number of drive-thru clients");
        ...
        caixaTextoDiasFuncional.addMouseListener(textfieldListener);
         ...
         caixaTextoNumeroMesas = new JTextField();
        ...
        caixaTextoFaturacaoMesa.addMouseListener(textfieldListener);
         ...
         caixaTextoNumeroClientesDriveThru = new JTextField();
        ...
        caixaTextoNumeroClientesDriveThru.addMouseListener(textfieldListener);
         ...
         caixaTextoFaturacaoDriveThru = new JTextField();
        ...
        frame.setTitle("Create a fast food restaurant");
